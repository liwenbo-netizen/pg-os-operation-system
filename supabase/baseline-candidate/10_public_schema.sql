...
create table "public"."media_budget_evaluations" (
  ...
  "total_score" numeric(5,2) default round(((((traffic_authenticity_score + ad_placement_value_score) + budget_fit_score) + tech_controllability_score) + compliance_score), 2),
  "media_grade" character varying(2) default 
CASE
...
create table "public"."media_ecosystem_opportunities" (
  ...
  "priority_score" integer default ((((((strategic_segment_score + user_scale_score) + ad_context_score) + integration_feasibility_score) + advertiser_demand_score) + commercial_feasibility_score) + risk_control_score),
...
-- PG_OS_APPLICATION_MANAGED constraints
